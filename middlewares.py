...
# Impedindo que nosso bot seja bloqueado
# Configurações setadas em settings
...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def _scrapeops_fake_user_agents_enabled(self):
        if self.scrapeops_api_key is None or self.scrapeops_api_key == '' or self.scrapeops_fake_user_agents_active \
                == False:
